...
set(ZDICTLIB_STATIC_API
    ""
    CACHE STRING
    "Visibility for ZDICTLIB_STATIC_API API"
)
set_property(
    CACHE ZSTDLIB_VISIBLE
    PROPERTY STRINGS "" "hidden" "default" "protected" "internal"
)
set_property(
    CACHE ZSTDERRORLIB_VISIBLE
    PROPERTY STRINGS "" "hidden" "default" "protected" "internal"
)
set_property(
    CACHE ZDICTLIB_VISIBLE
    PROPERTY STRINGS "" "hidden" "default" "protected" "internal"
)
set_property(
    CACHE ZSTDLIB_STATIC_API
    PROPERTY STRINGS "" "hidden" "default" "protected" "internal"
)
set_property(
    CACHE ZDICTLIB_STATIC_API
    PROPERTY STRINGS "" "hidden" "default" "protected" "internal"
)
...
if(MSVC)
    ...
    if(
        ...
        AND ${ZSTD_HAS_NOEXECSTACK}
    )
        enable_language(ASM)
        set(DecompressSources
            ${DecompressSources}
            ${LIBRARY_DIR}/huf_decompress_amd64.S
        )
    else()
        add_compile_options(-DZSTD_DISABLE_ASM)
    endif()
...
macro(add_definition target var)
    if(NOT ("${${var}}" STREQUAL ""))
        target_compile_definitions(
            ${target}
            PUBLIC "${var}=__attribute__((visibility(\"${${var}}\")))"
        )
    endif()
endmacro()
...
if(MSVC)
    set_property(
        ...
        APPEND
        PROPERTY COMPILE_DEFINITIONS "ZSTD_HEAPMODE=0;_CRT_SECURE_NO_WARNINGS"
    )
    ...
    set_target_properties(
        ...
        PROPERTIES
            ...
            PRODUCT_BUNDLE_IDENTIFIER
                "github.com/facebook/zstd/${STATIC_LIBRARY_BASE_NAME}"
